...
$result = mysqli_query($db, "SELECT * FROM `relat_dpt`");
                ...
                <li class="nav-item align-self-center page-heading">
                    <div class="page-header">
                        <div class="page-title">
                            <h3>Add Forword To Related Department</h3>
                        </div>
                    </div>
                </li>
            </ul>
            ...
            $(document).ready(function() {
                ...
                $('#insert_form').on("submit", function(event) {
                    ...
                    if ($('#cname').val() == "") {
                        ...
                        $.ajax({
                            url: "relateddepart/insert_update_dpt.php",
                            method: "POST",
                ...
                $(document).on('click', '.edit_data', function() {
                    ...
                    // alert(employee_id)
                    $.ajax({
                        url: "relateddepart/fetch_dpt.php",
                        method: "POST",
                        data: {
                ...
                $('.delete_product').click(function() {
                    ...
                    if (confirmalert == true) {
                        // AJAX Request
                        $.ajax({
                            url: 'relateddepart/delet_dpt.php',
                            type: 'POST',
                            data: {
                                id: deleteid
                            },
