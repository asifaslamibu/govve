...
$result = mysqli_query($db, "SELECT * FROM `calr_type`");
            ...
            $(document).ready(function() {
                ...
                $('#insert_form').on("submit", function(event) {
                    ...
                    if ($('#cname').val() == "") {
                        ...
                        $.ajax({
                            url: "calltype/invert_update_calr_type.php",
                            method: "POST",
                ...
                $(document).on('click', '.edit_data', function() {
                    ...
                    // alert(employee_id)
                    $.ajax({
                        url: "calltype/fatch_calr_type.php",
                        method: "POST",
                        data: {
                ...
                $('.delete_product').click(function() {
                    ...
                    if (confirmalert == true) {
                        // AJAX Request
                        $.ajax({
                            url: 'calltype/delete_calr_type.php',
                            type: 'POST',
                            data: {
                                id: deleteid
                            },
