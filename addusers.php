...
if (isset($_POST['submit'])) {
    ...
    $pri = mysqli_real_escape_string($db, $_POST['pri']);
    ...
    $sql = "INSERT INTO  users (`name`,`privilege`,`login`, `password`,`usersettings_id`,`status`,`description`,`email`,`dpt`)
    VALUES ('$name','$pri', '$email', '$encriped','1','1','$password','$email','$role')";
    // echo $sql;
                                ...
                                <div class="container my-4">
                                    <div class="row">
                                                ...
                                                <div class="form-row mb-4">
                                                    ...
                                                    <div class="form-group col-md-6  ">
                                                        ...
                                                        <label for="" class="lab"> Enter
                                                            Password</label>
                                                        <input type="password" id="password" required minlength="6" class="form-control input" placeholder="Enter Password">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" id="togglePassword" class="feather feather-eye" style="    position: absolute;top: 42px;right: 13px;color: #888ea8;fill: rgba(0, 23, 55, 0.08);width: 17px;cursor: pointer;">
                                                    ...
                                                    <div class="form-group col-md-6 ">
                                                        ...
                                                        <input type="password" id="confirm_password" name="confirm_password" required minlength="6" class="form-control input" placeholder="Confirm Password">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" id="togglePassword1" class="feather feather-eye" style="    position: absolute;top: 42px;right: 13px;color: #888ea8;fill: rgba(0, 23, 55, 0.08);width: 17px;cursor: pointer;">
                                                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z">
                                                            </path>
                                                            <circle cx="12" cy="12" r="3"></circle>
                                                        </svg>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="pri" name="pri" class="form-control selectpicker">
                                                            <option selected>Choose...</option>
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <button class="btn btn-success  font-weight-bold mx-2" name="submit" type="submit" style="float: right; ">SAVE</button>
